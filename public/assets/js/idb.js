// create avariable to hold db connection
let db;
// establish a connection to IndexedDbB database called "pizza_hunt" and set it to version 1
...
function saveRecord(record) {
  // open a new transaction with the database with read and write permisssions
...
function uploadPizza() {
  ...
  // upon a successful .getAll() expression, run this function
